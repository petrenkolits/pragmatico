...
class Project extends ProjectProperties implements Serializable {
  ...
  Double staticRating = 0.0f
  Double dynamicRating = 0.0f
  Double rating = 0.0f
  ...
  static constraints = {
    ...
    staticRating bindable: false, nullable: true
    dynamicRating bindable: false, nullable: true
